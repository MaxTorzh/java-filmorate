...
public class JdbcUserRepositoryIntegrationTest extends BaseIntegrationTest {
...
//                .build();
//
//        // Создаем пользователя без указания user_id
//        User createdUser = userRepository.createUser(user);
//
//        // Обновляем пользователя
//        User updatedUser = User.builder()
//                .id(createdUser.getId()) // Используем сгенерированный ID
